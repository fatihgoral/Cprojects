    ...
    scanf("%d", &secim);
        ...
        switch (secim) {
            ...
            // Şifalı bitki toplama ve avlanma işlemi
                ...
                int sifali_bitki_sans2 = sifali_bitki_sans * 100; // Ondalık değeri tam sayı yapmak için
                ...
                // Aynı şansla meyve toplama kontrolü
                    int sans2 = rand() % 100; // Rastgele şans değeri (0-99 arası)
                    double meyve_sans = (ozellikler[TOPLAYICILIK] * 4) / 100.0; // Yüzdelik oran hesaplama
                    int meyve_sans2 = meyve_sans * 100; // Ondalık değeri tam sayı yapmak için
                    ...
                    int sans3 = rand() % 100; // Rastgele şans değeri (0-99 arası)
                    double av_sans = (ozellikler[TOPLAYICILIK] * 4) / 100.0; // Yüzdelik oran hesaplama
                    int av_sans2 = (av_sans * 100)/2 ; // Ondalık değeri tam sayı yapmak için
                    if (sans3 < av_sans2) { //
        ...
        case 2:
            // Ormanı kesfe çık (Kolay)
            printf("Ormanda kolay bir kesfe ciktiniz!\n");

            // Kolay kesif- Haydutla savaş
            {
            ...
            // Orta keşif - Haydutla savaş
            {
                ...
                if (kacis < kacisBasarisi * 100) {
                    ...
                    if (oyuncuCan > 0) {
                        ...
                        if (ozellikler[TECRUBE] >= 100)
                            seviyeAtla(ozellikler);
                        ozellikler[ALTIN] += (rand() % 21 + 30);  // 30-50 arasında rastgele altın
                        printf("Haydut ganimeti: %.2f altin kazandiniz!\n", ozellikler[ALTIN]);
                    } else {
                        printf("Kaybettiniz!\n");
                        ozellikler[CAN] = 0;
                ...
                if (kacis < kacisBasarisi * 100) {
                    ...
                    if (oyuncuCan > 0) {
                        ...
                        ozellikler[UYKU]-=25;
                         if (ozellikler[TECRUBE] >= 100)
                            seviyeAtla(ozellikler);
                        ozellikler[ALTIN] += (rand() % 56 + 20);  // 55-75 arasında rastgele altın
                        printf("Haydut ganimeti: %.2f altin kazandiniz!\n", ozellikler[ALTIN]);
                    } else {
                        printf("Kaybettiniz!\n");
                        ozellikler[CAN] = 0;
